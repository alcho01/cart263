...
//When clicking a clue, display the set question
  mouseClicked() {
    //Column1
    //Make sure it is in the proper state
    if (state === 'BoardSelection'){
      //Add boolean to determine if clickable or not
      if (q1Cat1Answered === false) {
        ...
        if (mouseX > this.box1.x && mouseX < this.box1.x2) {
          if (mouseY > this.box1.y && mouseY < this.box1.y2) {
            ...
            this.scoreValue = 200;
            //Change boolean value when answer is correct, therefore the same question can't be spammed.
            q1Cat1Answered = true;
          }
        }
      }
